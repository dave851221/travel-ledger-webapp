...
const ItineraryCard: React.FC<{ icon: string; children: React.ReactNode }> = ({ icon, children }) => (
  <div className="relative pl-8 sm:pl-10 pb-8 last:pb-0">
    ...
    <div className="absolute left-0 top-0 w-7 h-7 sm:w-8 sm:h-8 rounded-full bg-white dark:bg-slate-800 border-2 border-teal-600 flex items-center justify-center z-10 shadow-sm text-xs sm:text-sm">
      {icon}
    </div>
