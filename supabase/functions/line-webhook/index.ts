...
// Fix 2: timezone-aware today string (Asia/Taipei)
...
`
        ...
        try {
          ...
          await replyMessage(replyToken, [{ type: 'text', text: '😵 AI 處理時發生錯誤，請稍後再試。' }], sourceId)
        }
        continue
      }
